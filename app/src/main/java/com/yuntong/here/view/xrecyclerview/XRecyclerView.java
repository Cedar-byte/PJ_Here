...
public class XRecyclerView extends RecyclerView {
    ...
    private int mRefreshProgressStyle = ProgressStyle.SysProgress;// 圈圈
    private int mLoadingMoreProgressStyle = ProgressStyle.SysProgress;// 圈圈
    ...
    private ArrowRefreshHeader mRefreshHeader;// 下拉刷新的header视图
    private boolean pullRefreshEnabled = true;// 是否能刷新
    private boolean loadingMoreEnabled = true;// 是否能加载更多
